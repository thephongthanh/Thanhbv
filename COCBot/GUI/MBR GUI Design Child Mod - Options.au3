...
GUISwitch($hGUI_ModOptions)
	...
	; SmartZap Settings
	Local $x = 20, $y = 25
	$grpStatsMisc = GUICtrlCreateGroup(GetTranslated(705,1, "SmartZap"), $x - 20, $y - 20, 437, 218 + 25)
	...
	$grpNewSmartZap = GUICtrlCreateGroup("", $x + 219, $y - 1, 192, 106 + 30)
		...
		$txtTip = GetTranslated(705,17, "Set value for expected gain every dark drill") & @CRLF & _
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
		$chkSmartZapSaveHeroes = GUICtrlCreateCheckbox(GetTranslated(705,21, "TH snipe NoZap if Heroes Deployed"), $x + 20 + 2, $y + 80, -1, -1)
		$txtTip = GetTranslated(705,22, "This will stop SmartZap from zapping a base on a Town Hall Snipe ") & @CRLF & _
				GetTranslated(705,23, "if your heroes were deployed. ") & @CRLF & @CRLF & _
				GetTranslated(705,24, "This protects their health so they will be ready for battle sooner!")
			GUICtrlSetTip(-1, $txtTip)
		...
		$lblLightningUsed = GUICtrlCreateLabel("0", $x + 20, $y + 110 + 33, 396, 30, $SS_CENTER)
			...
			$txtTip = GetTranslated(705,25, "Amount of used spells.")
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlCreateIcon($pIconLib, $eIcnDarkElixirStorage, $x - 12, $y + 150 + 30, 30, 30)
		$lblSmartZap = GUICtrlCreateLabel("0", $x + 20, $y + 150 + 30, 396, 30, $SS_CENTER)
			GUICtrlSetFont(-1, 16, $FW_BOLD, Default, "arial", $CLEARTYPE_QUALITY)
			GUICtrlSetBkColor (-1, 0xD7ECFF)
			$txtTip = GetTranslated(705,26, "Number of dark elixir zapped during the attack with lightning.")
			GUICtrlSetTip(-1, $txtTip)
	$x = 320
	$y = 265
		$chkDebugSmartZap = GUICtrlCreateCheckbox(GetTranslated(705,27, "DebugSZ"), $x + 50 + 2, $y + 80, -1, -1)
		$txtTip = GetTranslated(705,28, "Use it for debug SmartZap")
		GUICtrlSetTip(-1, $txtTip)
